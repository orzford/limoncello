...
class UsersApi extends BaseApi
{
    ...
    {
        $this->authorize(Rules::ACTION_MANAGE_USERS, Schema::TYPE);
    ...
    {
        $this->authorize(Rules::ACTION_MANAGE_USERS, Schema::TYPE, $index);
    ...
    {
        $this->authorize(Rules::ACTION_VIEW_TYPE, Schema::TYPE, $index);

        return $this->readRelationshipInt($index, Model::REL_TYPE, $relationshipFilters, $relationshipSorts);
    }
