...
class PassportSeed implements SeedInterface
{
     ...
     * Scope ID
     */
    const SCOPE_ADMIN_USER_TYPES = 'manage_user_types';
     ...
     * Scope ID
     */
    const SCOPE_VIEW_USER_TYPES = 'view_user_types';
    ...
    public function run(): void
    {
        ...
        $scopes = [
            ...
            static::SCOPE_ADMIN_USER_TYPES => 'Can create, update and delete user types.',
            static::SCOPE_ADMIN_ROLES      => 'Can create, update and delete roles.',
            static::SCOPE_VIEW_USERS       => 'Can view users.',
            static::SCOPE_VIEW_USER_TYPES  => 'Can view user types.',
        ...
        $this->assignScopes(RolesSeed::ID_ADMINISTRATORS, [
            ...
            static::SCOPE_ADMIN_USER_TYPES,
            static::SCOPE_ADMIN_ROLES,
            static::SCOPE_VIEW_USERS,
            static::SCOPE_VIEW_USER_TYPES,
        ...
        $this->assignScopes(RolesSeed::ROLE_USERS, [
            static::SCOPE_VIEW_USERS,
        ]);
    }
